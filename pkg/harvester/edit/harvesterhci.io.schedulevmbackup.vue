  ...
  >
    ...
    <Tabbed v-bind="$attrs" class="mt-15" :side-tabs="true">
      <Tab name="basics" :label="t('harvester.network.tabs.basics')" :weight="99" class="bordered-table">
        ...
        />
        <Checkbox
          v-model="value.spec.resumeRequest"
          class="mt-10"
          :label="t('harvester.schedule.autoResume.label')"
          :tooltip="t('harvester.schedule.autoResume.tooltip')"
          type="checkbox"
          :disabled="isBackupTargetUnAvailable || isView"
          :mode="mode"
        />
